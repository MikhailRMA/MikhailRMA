...
| [Анализ и очистка "грязных" данных](https://github.com/MikhailRMA/WorkSpace/tree/main/dirty_data_analysis) |  Исправлению данных с типичными проблемами (пропуски и дубликаты, нестандартные форматы данных, выбросы и аномалии, текстные ошибки и опечатки) | *python, pandas, matplotlib, re, numpy* |
